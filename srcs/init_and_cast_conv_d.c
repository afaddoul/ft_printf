...
/*   Updated: 2019/08/05 13:32:54 by afaddoul         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	d = ft_memalloc_protected(sizeof(t_conv_d));
	d->zr = 0;
	d->sign = 0;
	d->sp = 0;
	d->len = 0;
...
{
	x = ft_memalloc_protected(sizeof(t_conv_x));
	x->hex = NULL;
	x->zr = 0;
	x->sign = 0;
	x->sp = 0;
...
{
	o = ft_memalloc_protected(sizeof(t_conv_o));
	o->oct = NULL;
	o->zr = 0;
	o->sign = 0;
	o->sp = 0;
