...
/*   Updated: 2019/08/05 13:33:41 by afaddoul         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			merge(t_tmp_data **arr, int l, int m, int r)
{
	...
	arrs = ft_memalloc_protected(sizeof(t_points));
	arrs->left = ft_memalloc_protected(sizeof(t_tmp_data *) * optim.n1);
	arrs->right = ft_memalloc_protected(sizeof(t_tmp_data *) * optim.n2);
